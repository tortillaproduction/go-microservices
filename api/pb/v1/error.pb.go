//
// A proto file defining the Error type.
//
...
const file_error_proto_rawDesc = "" +
	"\n" +
	"\verror.proto\x12\bproto.v1\"5\n" +
	"\x05Error\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessageB\x9a\x01\n" +
	"\fcom.proto.v1B\n" +
	"ErrorProtoP\x01Z=github.com/tortillaproduction/go-microservices/api/pb/v1;pbv1\xa2\x02\x03PXX\xaa\x02\bProto.V1\xca\x02\bProto\\V1\xe2\x02\x14Proto\\V1\\GPBMetadata\xea\x02\tProto::V1b\x06proto3"
