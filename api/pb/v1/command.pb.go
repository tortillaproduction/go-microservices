...
type CategoryUpParam struct {
	...
	Crud          CRUD                   `protobuf:"varint,1,opt,name=crud,proto3,enum=proto.v1.CRUD" json:"crud,omitempty"`
...
const file_command_proto_rawDesc = "" +
	"\n" +
	"\rcommand.proto\x12\bproto.v1\x1a\verror.proto\x1a\fmodels.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"Y\n" +
	"\x0fCategoryUpParam\x12\"\n" +
	"\x04crud\x18\x01 \x01(\x0e2\x0e.proto.v1.CRUDR\x04crud\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\"\x8e\x01\n" +
	"\x0eProductUpParam\x12\"\n" +
	"\x04crud\x18\x01 \x01(\x0e2\x0e.proto.v1.CRUDR\x04crud\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x12\n" +
	...
	"\bcategory\x18\x01 \x01(\v2\x12.proto.v1.CategoryR\bcategory\x12%\n" +
	...
	"\aproduct\x18\x01 \x01(\v2\x11.proto.v1.ProductR\aproduct\x12%\n" +
	"\x05error\x18\x02 \x01(\v2\x0f.proto.v1.ErrorR\x05error\x128\n" +
	...
	"\n" +
	"\x06DELETE\x10\x032\xd4\x01\n" +
	"\x0fCategoryCommand\x12?\n" +
	"\x06Create\x12\x19.proto.v1.CategoryUpParam\x1a\x1a.proto.v1.CategoryUpResult\x12?\n" +
	"\x06Update\x12\x19.proto.v1.CategoryUpParam\x1a\x1a.proto.v1.CategoryUpResult\x12?\n" +
	"\x06Delete\x12\x19.proto.v1.CategoryUpParam\x1a\x1a.proto.v1.CategoryUpResult2\xcd\x01\n" +
	"\x0eProductCommand\x12=\n" +
	"\x06Create\x12\x18.proto.v1.ProductUpParam\x1a\x19.proto.v1.ProductUpResult\x12=\n" +
	"\x06Update\x12\x18.proto.v1.ProductUpParam\x1a\x19.proto.v1.ProductUpResult\x12=\n" +
	"\x06Delete\x12\x18.proto.v1.ProductUpParam\x1a\x19.proto.v1.ProductUpResultB\x9c\x01\n" +
	"\fcom.proto.v1B\fCommandProtoP\x01Z=github.com/tortillaproduction/go-microservices/api/pb/v1;pbv1\xa2\x02\x03PXX\xaa\x02\bProto.V1\xca\x02\bProto\\V1\xe2\x02\x14Proto\\V1\\GPBMetadata\xea\x02\tProto::V1b\x06proto3"
...
var file_command_proto_goTypes = []any{
	(CRUD)(0),                     // 0: proto.v1.CRUD
	(*CategoryUpParam)(nil),       // 1: proto.v1.CategoryUpParam
	(*ProductUpParam)(nil),        // 2: proto.v1.ProductUpParam
	(*CategoryUpResult)(nil),      // 3: proto.v1.CategoryUpResult
	(*ProductUpResult)(nil),       // 4: proto.v1.ProductUpResult
	(*Category)(nil),              // 5: proto.v1.Category
	(*Error)(nil),                 // 6: proto.v1.Error
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
	(*Product)(nil),               // 8: proto.v1.Product
}
var file_command_proto_depIdxs = []int32{
	0,  // 0: proto.v1.CategoryUpParam.crud:type_name -> proto.v1.CRUD
	0,  // 1: proto.v1.ProductUpParam.crud:type_name -> proto.v1.CRUD
	5,  // 2: proto.v1.CategoryUpResult.category:type_name -> proto.v1.Category
	6,  // 3: proto.v1.CategoryUpResult.error:type_name -> proto.v1.Error
	7,  // 4: proto.v1.CategoryUpResult.timestamp:type_name -> google.protobuf.Timestamp
	8,  // 5: proto.v1.ProductUpResult.product:type_name -> proto.v1.Product
	6,  // 6: proto.v1.ProductUpResult.error:type_name -> proto.v1.Error
	7,  // 7: proto.v1.ProductUpResult.timestamp:type_name -> google.protobuf.Timestamp
	1,  // 8: proto.v1.CategoryCommand.Create:input_type -> proto.v1.CategoryUpParam
	1,  // 9: proto.v1.CategoryCommand.Update:input_type -> proto.v1.CategoryUpParam
	1,  // 10: proto.v1.CategoryCommand.Delete:input_type -> proto.v1.CategoryUpParam
	2,  // 11: proto.v1.ProductCommand.Create:input_type -> proto.v1.ProductUpParam
	2,  // 12: proto.v1.ProductCommand.Update:input_type -> proto.v1.ProductUpParam
	2,  // 13: proto.v1.ProductCommand.Delete:input_type -> proto.v1.ProductUpParam
	3,  // 14: proto.v1.CategoryCommand.Create:output_type -> proto.v1.CategoryUpResult
	3,  // 15: proto.v1.CategoryCommand.Update:output_type -> proto.v1.CategoryUpResult
	3,  // 16: proto.v1.CategoryCommand.Delete:output_type -> proto.v1.CategoryUpResult
	4,  // 17: proto.v1.ProductCommand.Create:output_type -> proto.v1.ProductUpResult
	4,  // 18: proto.v1.ProductCommand.Update:output_type -> proto.v1.ProductUpResult
	4,  // 19: proto.v1.ProductCommand.Delete:output_type -> proto.v1.ProductUpResult
